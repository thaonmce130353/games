...
function App() {
    ...
    return ( <
        ...
        <
        div className = {
            overlay ? "container blur" : "container"
        } >
        <
        Header onClick = {
        ...
        onClick = {
            (index) => handleOnClickCell(index)
        }
        /> <
        Sidebar gameDifficulty = {
            gameDifficulty
        }
        numberSelected = {
            numberSelected
        ...
        onClick = {
            (number) => handleOnClickNumber(number)
        }
        onChange = {
            (e) => handleChangeGameDifficulty(e)
        }
        onClickUndo = {
            handleOnClickUndo
        }
        ...
        /div> <
        div className = {
            overlay ? "overlay overlay--visible" : "overlay"
        }
        onClick = {
