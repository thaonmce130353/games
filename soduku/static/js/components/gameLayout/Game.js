export const Game = (props) => {
    ...
    function _selectedCell(givenIndex, givenValue) {
        if (givenValue !== 0) {
            if (props.initialGameGrid[givenIndex] === 0) {
                return ( <
                    td className = "game__cell game__cell--userfilled game__cell--selected"
                    key = {
                        givenIndex
                    }
                    onClick = {
                        () => props.onClick(givenIndex)
                    } > {
                        givenValue
                    } <
                    /td>
                ...
                return ( <
                    td className = "game__cell game__cell--filled game__cell--selected"
                    key = {
                        givenIndex
                    }
                    onClick = {
            ...
            return ( <
                td className = "game__cell game__cell--selected"
                key = {
                    givenIndex
                }
                onClick = {
    ...
    function _unselectedCell(givenIndex, value) {
        if (value !== 0) {
            if (props.initialGameGrid[givenIndex] === 0) {
                return ( <
                    td className = "game__cell game__cell--userfilled"
                    key = {
                        givenIndex
                    }
                    onClick = {
                ...
                return ( <
                    td className = "game__cell game__cell--filled"
                    key = {
                        givenIndex
                    }
                    onClick = {
                            ...
                            if (props.cellSelected === index) {
                                if (value !== 0) {
                                    if (props.initialGameGrid[index] === 0) {
                                        return ( <
                                            td className = "game__cell game__cell--userfilled game__cell--highlightselected"
                                            key = {
                                                index
                                            }
                                            onClick = {
                                        ...
                                        return ( <
                                            td className = "game__cell game__cell--filled game__cell--highlightselected"
                                            key = {
                                                index
                                            }
                                            onClick = {
                                    ...
                                    return ( <
                                        td className = "game__cell game__cell--highlightselected"
                                        key = {
                                            index
                                        }
                                        onClick = {
