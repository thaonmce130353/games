...
var Preload = /** @class */ (function() {
    function Preload() {
        ...
        this.gameovertxt = SimpleGame.myGame.make.text(800 / 2, 600 / 2, "Bubble Shooter is loading ", {
            font: "42px Arial",
            fill: "#ffffff",
            fontWeight: "700",
            align: "Right"
...
var Bubble = /** @class */ (function() {
    ...
    Bubble.prototype.setToMyRealCoord = function(immediateFlag) {
        ...
        if (immediateFlag) {
            ...
            SimpleGame.myGame.add.tween(this.imgSprite).to({
                x: this.defaultRealX,
                y: this.defaultRealY
            }, 90, Phaser.Easing.Linear.None, true);
        }
    };
    ...
    Bubble.prototype.arrivedTween = function() {
        ...
        SimpleGame.myGame.add.tween(this.imgSprite.scale).to({
            x: 0.8,
            y: 0.8
        }, 50, Phaser.Easing.Linear.None, true, 0);
    };
    Bubble.prototype.arrivedTweenStart = function() {
        this.imgSprite.scale.x = 1;
        this.imgSprite.scale.y = 1;
        SimpleGame.myGame.add.tween(this.imgSprite.scale).from({
            x: 0.8,
            y: 0.8
...
var AddScore = /** @class */ (function() {
    function AddScore(score, addTopTenScreenAfterThis) {
        if (addTopTenScreenAfterThis === void 0) {
            addTopTenScreenAfterThis = false;
        }
...
var ButtonWithTween = /** @class */ (function() {
    ...
    ButtonWithTween.prototype.onButtonOver = function() {
        ...
        if (SimpleGame.myGame.device.android == false && SimpleGame.myGame.device.iOS == false) {
            this.buttonTween = SimpleGame.myGame.add.tween(this.imgNormal.scale).to({
                x: 0.75,
                y: 0.75
            }, 150, Phaser.Easing.Linear.None, true, 0, 1000000000000, true);
        }
