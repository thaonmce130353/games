var MainGame = {
  ...
  api_analytics: function (vValue, vLevel) {
    /*if(vLevel){console.log("api_analytics",vValue,vLevel)}else{console.log("api_analytics",vValue)}if(MainGame.isDebug)return;switch(vValue){case"MaxTextureSize":GameAnalytics("addDesignEvent",vValue+":"+vLevel,1);break;case"MaxLevelCar":GameAnalytics("addDesignEvent",vValue+":"+vLevel,1);break;case"EASY3ROW":GameAnalytics("addDesignEvent",vValue+":"+vLevel,1);break;case"DEFEAT2ROW":GameAnalytics("addDesignEvent",vValue+":"+vLevel,1);break;case"ClickCoinsX2":GameAnalytics("addDesignEvent",vValue,1);break;case"ClickNoThanks":GameAnalytics("addDesignEvent",vValue,1);break;case"Start":GameAnalytics("addProgressionEvent","Start","wave"+vLevel);break;case"Fail":GameAnalytics("addProgressionEvent","Fail","wave"+vLevel);break;case"Complete":GameAnalytics("addProgressionEvent","Complete","wave"+vLevel);break}*/
  },
  ...
  loadSaves: function () {
    ...
    MainGame.cdBonusMerge = MainGame.Storage.get(
      MainGame.title + "-" + "cdBonusMerge"
    );
    ...
    MainGame.levelCannonDmg = MainGame.Storage.get(
      MainGame.title + "-" + "levelCannonDmg"
    );
    ...
    MainGame.level_wall = MainGame.Storage.get(
      MainGame.title + "-" + "level_wall"
    );
...
MainGame.Sfx = {
  manage: function (type, mode, game, button, label) {
    ...
    switch (mode) {
      case "init": {
        ...
        if (type == "sound") {
          MainGame.Sfx.sounds = [];
          MainGame.Sfx.sounds["after_exposion"] =
            game.sound.add("after_exposion2");
          ...
          MainGame.Sfx.sounds["merge_unlocked"] =
            game.sound.add("merge_unlocked2");
          ...
          MainGame.Sfx.sounds["shoot_blaster1"] =
            game.sound.add("shoot_blaster1");
          MainGame.Sfx.sounds["shoot_blaster2"] =
            game.sound.add("shoot_blaster2");
          MainGame.Sfx.sounds["shoot_blaster3"] =
            game.sound.add("shoot_blaster3");
          MainGame.Sfx.sounds["shoot_blaster4"] =
            game.sound.add("shoot_blaster4");
          MainGame.Sfx.sounds["shoot_machine1"] =
            game.sound.add("shoot_machine1");
          MainGame.Sfx.sounds["shoot_machine2"] =
            game.sound.add("shoot_machine2");
          MainGame.Sfx.sounds["shoot_machine3"] =
            game.sound.add("shoot_machine3");
          MainGame.Sfx.sounds["shoot_machine4"] =
            game.sound.add("shoot_machine4");
          MainGame.Sfx.sounds["shoot_pistol1"] =
            game.sound.add("shoot_pistol1");
          MainGame.Sfx.sounds["shoot_pistol2"] =
            game.sound.add("shoot_pistol2");
          MainGame.Sfx.sounds["shoot_pistol3"] =
            game.sound.add("shoot_pistol3");
          MainGame.Sfx.sounds["shoot_pistol4"] =
            game.sound.add("shoot_pistol4");
          ...
          MainGame.Sfx.sounds["shoot_shotgun1"] =
            game.sound.add("shoot_shotgun1");
          MainGame.Sfx.sounds["shoot_shotgun2"] =
            game.sound.add("shoot_shotgun2");
          MainGame.Sfx.sounds["shoot_shotgun3"] =
            game.sound.add("shoot_shotgun3");
          MainGame.Sfx.sounds["shoot_shotgun4"] =
            game.sound.add("shoot_shotgun4");
          MainGame.Sfx.sounds["show_box"] = game.sound.add("show_box");
          MainGame.Sfx.sounds["skill_grenade"] =
            game.sound.add("skill_grenade");
          ...
          MainGame.Sfx.sounds["after_exposion"].volume = 0.85;
          ...
          MainGame.Sfx.sounds["exposion3"].volume = 0.6;
          MainGame.Sfx.sounds["exposion4"].volume = 0.6;
          MainGame.Sfx.sounds["fortune"].volume = 1.5;
          MainGame.Sfx.sounds["heal"].volume = 1;
          MainGame.Sfx.sounds["knock1"].volume = 0.9;
          MainGame.Sfx.sounds["knock2"].volume = 0.9;
          MainGame.Sfx.sounds["knock3"].volume = 0.9;
          MainGame.Sfx.sounds["knock4"].volume = 0.9;
          MainGame.Sfx.sounds["knock5"].volume = 0.9;
          MainGame.Sfx.sounds["knock6"].volume = 0.9;
          MainGame.Sfx.sounds["knock7"].volume = 0.6;
          MainGame.Sfx.sounds["knock8"].volume = 0.6;
          MainGame.Sfx.sounds["knock9"].volume = 0.25;
          MainGame.Sfx.sounds["lvl_up"].volume = 0.9;
          ...
          MainGame.Sfx.sounds["shoot_auto1"].volume = 0.9;
          MainGame.Sfx.sounds["shoot_auto2"].volume = 0.9;
          MainGame.Sfx.sounds["shoot_auto3"].volume = 0.9;
          MainGame.Sfx.sounds["shoot_auto4"].volume = 0.9;
          ...
          MainGame.Sfx.sounds["shoot_machine2"].volume = 0.8;
          MainGame.Sfx.sounds["shoot_machine3"].volume = 1;
          MainGame.Sfx.sounds["shoot_machine4"].volume = 0.8;
          MainGame.Sfx.sounds["shoot_pistol1"].volume = 0.7;
          MainGame.Sfx.sounds["shoot_pistol2"].volume = 0.9;
          MainGame.Sfx.sounds["shoot_pistol3"].volume = 0.7;
          MainGame.Sfx.sounds["shoot_pistol4"].volume = 0.7;
          MainGame.Sfx.sounds["shoot_rifle1"].volume = 1;
          MainGame.Sfx.sounds["shoot_rifle2"].volume = 1;
          MainGame.Sfx.sounds["shoot_rifle3"].volume = 0.8;
          MainGame.Sfx.sounds["shoot_rifle4"].volume = 0.8;
          ...
          MainGame.Sfx.sounds["k_aaa1"].volume = 0.3;
          MainGame.Sfx.sounds["k_aaa2"].volume = 0.3;
          MainGame.Sfx.sounds["k_aaa3"].volume = 0.3;
          MainGame.Sfx.sounds["k_aaa4"].volume = 0.3;
          MainGame.Sfx.sounds["k_aaa5"].volume = 0.3;
          MainGame.Sfx.sounds["k_aaa6"].volume = 0.3;
          MainGame.Sfx.sounds["k_aaa7"].volume = 0.3;
          MainGame.Sfx.sounds["k_aaa8"].volume = 0.3;
          MainGame.Sfx.sounds["k_aaa9"].volume = 0.3;
          MainGame.Sfx.sounds["wave_defeat"].volume = 0.8;
          MainGame.Sfx.sounds["wave_finish"].volume = 0.9;
          ...
          MainGame.Sfx.musics["main"].volume = 0.85;
        }
        break;
      }
      case "on": {
  ...
  play: function (type, audio) {
    if (MainGame.isAudioDisable || MainGame.isDebug) {
      return;
    }
    ...
    if (type === "music") {
      ...
      if (MainGame.Sfx.musics) {
        const currentMusic = MainGame.Sfx.musics[MainGame.Sfx.nameMusicPlaying];
        const newMusic = MainGame.Sfx.musics[audio];
      ...
      const sound = MainGame.Sfx.sounds && MainGame.Sfx.sounds[audio];
      if (sound) {
        sound.play();
      }
    }
  ...
  update: function (type, button, label) {
    if (MainGame.isAudioDisable || MainGame.Sfx.status === undefined) {
      return;
    }

    const isTypeEnabled = MainGame.Sfx.status[type];

    if (button) {
      button.setFrame(`btn_${type}_${isTypeEnabled ? "0000" : "0001"}`);
    }

    if (label) {
      const labelText = isTypeEnabled
        ? MainGame.GAME_TEXT[`${type}_on`].toUpperCase()
        : MainGame.GAME_TEXT[`${type}_off`].toUpperCase();
...
class Game extends Phaser.Scene {
  ...
  goAutoMerge(vId1, vId2) {
    ...
    parking1.item.setViewAlpha(0.5);
    parking2.item.setViewAlpha(0.5);
  ...
  finishCursorTween() {
    ...
    if (MainGame.state.linkToOldParking && MainGame.state.linkToOldParking.item)
      MainGame.state.linkToOldParking.item.setViewAlpha(1);
  ...
  cancelUpgrade() {
    if (this.infoMerge)
      this.onMergePart(
        this.infoMerge.vObj,
        this.infoMerge.vType,
        this.infoMerge.vIsAuto
      );
    this.infoMerge = null;
  }
    ...
    if (this.nextCarLevel == nextType) {
      ...
      if (MainGame.debug_isFreeUpgrade) {
        ...
        if (nextType < this.nextCarLevel - this.MIN_LVL_UPGRADE && !vIsAuto) {
          ...
          if (
            this.offerFreeUpgrade >= this.ALLOW_UPGRADE &&
            !this.isAutoMerge
          ) {
            this.parking_upgrade_id = toParking.id;
            this.parking_upgrade_type = nextType + 2;
  ...
  initSettingsGame() {
    ...
    this.DEPTH_layerWall = 0.02;
    this.DEPTH_hightlight = 0.025;
    this.DEPTH_layerTowers = 0.03;
    this.DEPTH_layerHpBars = 0.04;
    this.DEPTH_panel_number = 0.05;
    this.DEPTH_text_number = 0.06;
    this.DEPTH_effect_unboxing = 0.07;
    this.DEPTH_layerSpine = 0.08;
    this.DEPTH_layerEffects = 0.09;
    this.DEPTH_cursorcar = 0.091;
    this.DEPTH_cursorSpine = 0.092;
    this.DEPTH_layerDmgText = 0.095;
    this.DEPTH_GUI = 0.1;
  ...
  checkAutoPlay() {
    ...
    if (action) return;
    if (this.num_wave > 10) {
      if (this.wall_hp < this.wall_hp_max * 0.35) action = true;
    }
    if (action) return;
  ...
  checkWorkFields() {
    ...
    if (parkingBattleId >= 0 && maxParkingId >= 0) {
      ...
      if (toParking.busy) {
        if (fromParking.obj == 1 && fromParking.item.count_box_tween > 0)
          this.openBox(fromParking, true);
  ...
  getCountSpecialHp(vNumWave, vType) {
    ...
    if (vType == 51 || vType == 52 || vType == 53) {
      if (vNumWave <= 10) {
        return 2100 * Math.floor(Math.pow(1.5, vNumWave));
      } else {
        return 88 * Math.floor(Math.pow(2.07, vNumWave));
      }
    }
    if (vType == 6) {
      if (vNumWave <= 10) {
  ...
  addObject(data, vIsSound) {
    ...
    if (free_park_num >= 0) {
      ...
      if (data.parkingId == null || data.skinBox) {
        ...
        car.setViewScale(this.getScaleCar(0.6));
        car.setViewAlpha(0.5);
        this.tweens.add({
          targets: car.view,
  ...
  openBox(vParking, vIsAnimScale) {
    ...
    if (vIsAnimScale) {
      ...
      vObj.setViewScale(this.getScaleCar(0.6));
      vObj.setViewAlpha(0.5);
      this.tweens.add({
        targets: vObj.view,
        scale: this.getScaleCar(1),
        ease: Phaser.Math.Easing.Back.Out,
  ...
  getMaxParkingPair(isForAutoMerge, vIsBattleField) {
    ...
    for (var i = 0; i < this.LIMIT_parking; i++) {
      ...
      if (
        ...
        if (
          parking.obj == 1 &&
          parking.item.count_box_tween != null &&
          parking.item.count_box_tween <= 0
        ) {
          if (parking.id < 5 && !vIsBattleField) continue;
          if (
            isForAutoMerge &&
            this.selectedCar &&
            parking.id == this.selectedCar.id
          )
            continue;
          valuesTypes.push({
            id: parking.id,
  ...
  activateBoostCoins(vTime, isFromLoad) {
    ...
    if (!isFromLoad && this.countDownBonusCoins > 0) {
      ...
      this.gameGUI.updateIndcatorBoostCoins(
        MainGame.secToHHMMSS(this.countDownBonusCoins)
      );
      return;
    }
    this.countDownBonusCoins = vTime;
  ...
  activateBoostAutoMerge(vTime, isFromLoad) {
    ...
    if (!isFromLoad && this.countDownBonusAutoMerge > 0) {
      ...
      this.gameGUI.updateIndcatorBoostAutoMerge(
        MainGame.secToHHMMSS(this.countDownBonusAutoMerge)
      );
      return;
    }
    this.countDownBonusAutoMerge = vTime;
  ...
  activateBoostSpeed(vTime, isFromLoad) {
    ...
    if (!isFromLoad && this.countDownBonusSpeed > 0) {
      ...
      this.gameGUI.updateIndcatorBoostSpeed(
        MainGame.secToHHMMSS(this.countDownBonusSpeed)
      );
      return;
    }
    this.countDownBonusSpeed = vTime;
  ...
  initWave() {
    this.gameGUI.showSystemMessage(
      MainGame.GAME_TEXT.wave_new.toUpperCase() + " " + this.num_wave
    );
  ...
  getGeneratedSquad(vNumWave) {
    ...
    for (var i = 0; i < countLines; i++) {
      ...
      r2 = MyMath.getRandomInt(0, countPresets);
      mobsLine = mobsLine.concat(presets[r1]);
      mobsLine = mobsLine.concat(presets[r2]);
  ...
  debugShowWaveInfo() {
    ...
    for (var i = 0; i < this.wave_squard.length; i++) {
      ...
      typeMob = this.wave_squard[i].t;
      if (typeMob >= 100) {
        timeWave += times[1] * 0.92;
      } else {
        timeWave += times[typeSquad] * 0.92;
      }
      if (typeMob >= 100) countBosses++;
    ...
    var coins1 = this.getCountMobCoins(this.num_wave) * countMobs;
    var coins2 = this.getCountBossCoins(this.num_wave) * countBosses;
    var total_coins = coins1 + coins2;
    var hpMobs = this.getCountMobHp(this.num_wave);
    var hpBoss = this.getCountBossHp(this.num_wave);
    var timeWaveS = Math.round((timeWave + Number.EPSILON) * 100) / 100;
    var timeWaveM = Math.round((timeWave / 60 + Number.EPSILON) * 100) * 0.01;
    console.log("====================");
    console.log("numWave", this.num_wave);
    console.log("timeWave: ", timeWaveS + "s", "(~" + timeWaveM + "m)");
    console.log("countMobs", countMobs);
    console.log("countBosses", countBosses);
    console.log("coinsMob", "" + MainGame.convertNumberFormat(coins1));
    console.log("coinsBoss", "" + MainGame.convertNumberFormat(coins2));
    console.log("coinsTotal", "" + MainGame.convertNumberFormat(total_coins));
    console.log("hpMobs", "" + MainGame.convertNumberFormat(hpMobs));
    console.log("hpBoss", "" + MainGame.convertNumberFormat(hpBoss));
    console.log("====================");
  }
  updateWave() {
  ...
  enemyKilled(vType, vIsSkipCoin) {
    ...
    if (
      !this.isGameOver &&
      !this.isFinishGame &&
      this.enemies_killed >= this.countEnemies
    ) {
      if (MainGame.isDebug) {
        this.debugCheckSave();
      }
  ...
  getDifficulty() {
    var value = "";
    if (this.wall_hp_dmg > this.wall_hp_start * 0.7) {
      value = "HARD";
    } else if (this.wall_hp_dmg < this.wall_hp_start * 0.15) {
      value = "EASY";
    } else {
      value = "NORMAL";
    }
  ...
  debugCheckSave() {
    if (
      MainGame.isDebug &&
      !MainGame.isNoSave &&
      MainGame.NUM_WAVE_SAVE < this.num_wave
    ) {
  ...
  getEnemy(x, y, distance) {
    ...
    for (var i = 0; i < enemyUnits.length; i++) {
      ...
      if (
        enemy.active &&
        (enemy.x > this.START_ENEMY_X || enemy.isDamaged()) &&
        !enemy.isUnderAttack
      ) {
  ...
  showBulletEffect(vTarget, vDamage, vDmgText, vX1, vY1, vX2, vY2, angle) {
    ...
    var posX = (vX1 + vX2) * 0.5;
    var posY = (vY1 + vY2) * 0.5;
  ...
  initWall() {
    ...
    var fire1 = this.add.sprite(
      this.WALL_X - 5,
      this.FIRE_Y + 50 * 0,
      "ss_main"
    );
    fire1.play("fire1");
    var fire2 = this.add.sprite(
      this.WALL_X - 5,
      this.FIRE_Y + 50 * 1,
      "ss_main"
    );
    fire2.play("fire1");
    var fire3 = this.add.sprite(
      this.WALL_X - 5,
      this.FIRE_Y + 50 * 2,
      "ss_main"
    );
    fire3.play("fire1");
    var fire4 = this.add.sprite(
      this.WALL_X - 5,
      this.FIRE_Y + 50 * 3,
      "ss_main"
    );
    fire4.play("fire1");
    var fire5 = this.add.sprite(
      this.WALL_X - 5,
      this.FIRE_Y + 50 * 4,
      "ss_main"
    );
    fire5.play("fire1");
    var fire6 = this.add.sprite(
      this.WALL_X - 5,
      this.FIRE_Y + 50 * 5,
      "ss_main"
    );
    fire6.play("fire1");
    var fire7 = this.add.sprite(
      this.WALL_X - 5,
      this.FIRE_Y + 50 * 6,
      "ss_main"
    );
    fire7.play("fire1");
    var fire8 = this.add.sprite(
      this.WALL_X - 5,
      this.FIRE_Y + 50 * 7,
      "ss_main"
    );
  ...
  setFiresWall() {
    ...
    for (var i = 0; i < this.arFires.length; i++) {
      ...
      if (r == 1) this.arFires[i].setOrigin(0.5, 0.5);
      if (r == 2) this.arFires[i].setOrigin(0.5, 0.5);
      if (r == 3) this.arFires[i].setOrigin(0.32, 0.5);
      if (r == 4) this.arFires[i].setOrigin(0.7, 0.5);
  ...
  updateWallHp(damage) {
    ...
    if (this.wall_hp < this.wall_hp_max * 0.9) this.arFires[0].visible = true;
    if (this.wall_hp < this.wall_hp_max * 0.8) this.arFires[1].visible = true;
    if (this.wall_hp < this.wall_hp_max * 0.7) this.arFires[2].visible = true;
    if (this.wall_hp < this.wall_hp_max * 0.6) this.arFires[3].visible = true;
    if (this.wall_hp < this.wall_hp_max * 0.5) this.arFires[4].visible = true;
    if (this.wall_hp < this.wall_hp_max * 0.4) this.arFires[5].visible = true;
    if (this.wall_hp < this.wall_hp_max * 0.3) this.arFires[6].visible = true;
    if (this.wall_hp < this.wall_hp_max * 0.2) this.arFires[7].visible = true;
    if (this.wall_hp <= 0) {
      this.wall_hp = 0;
      this.defeatWave();
    }
    this.gameGUI.updateWallHp(
      this.wall_hp / this.wall_hp_max,
      this.wall_hp,
      this.wall_hp_max
    );
  ...
  showWallJelly() {
    ...
    this.goTweenWall(this.wall, 0.04);
  }
  ...
  useSkill3() {
    ...
    this.smokeDamage = Math.round(this.getCountMobHp(this.num_wave) * 0.04);
    var pos = {
      x: this.aim_skill.x,
      y: this.aim_skill.y,
    };
    ...
    this.delayPoison = 0;
    var effect = this.showEffect(
      this.smokePoison.x - 8,
      this.smokePoison.y - 10,
      "acid1"
    );
  ...
  initWheelOptions() {
    this.wheelOptions = {
      ...
      sliceProbability: [0.18, 0.12, 0.08, 0.1, 0.18, 0.12, 0.04, 0.18],
      rotationTime: 3e3,
      rotationTimeRange: {
        min: 3e3,
        max: 4500,
  ...
  updatePrivilegiesItems() {
    ...
    if (value_level < 10) {
      ...
      this.itemPrivilege1.text_value.setText(
        MainGame.GAME_TEXT.next_level.toUpperCase() +
          ": " +
          itemInfo.value +
          "%"
      );
      ...
      this.itemPrivilege1.text_value.setOrigin(0.5);
    ...
    if (value_level < 10) {
      ...
      priceItem = Math.round(itemInfo.price * this.factorDiscount);
      number_warm = MainGame.convertNumberFormat(priceItem);
      this.itemPrivilege2.text_value.setText(
        MainGame.GAME_TEXT.next_level.toUpperCase() +
          ": " +
          itemInfo.value +
          "%"
      ...
      this.itemPrivilege2.text_value.setOrigin(0.5);
    ...
    if (value_level < 10) {
      ...
      priceItem = Math.round(itemInfo.price * this.factorDiscount);
      number_warm = MainGame.convertNumberFormat(priceItem);
      this.itemPrivilege3.text_value.setText(
        MainGame.GAME_TEXT.next_level.toUpperCase() +
          ": " +
          itemInfo.value +
          "%"
      ...
      this.itemPrivilege3.text_value.setOrigin(0.5);
  ...
  debugShowPrices() {
    var ar = [
      5e5, 25e6, 125e7, 625e8, 3125e9, 15625e10, 78125e11, 390625e12,
      1953125e13, 9765625e14,
    ];
  ...
  testAllowParking() {
    for (var i = 0; i < this.arParking.length; i++) {
      if (!this.arParking[i].allow)
        console.log("[!!!]", i, this.arParking[i].allow);
    }
  }
  testAddBoxes() {
...
class GameGui extends Phaser.Scene {
  ...
  create() {
    ...
    this.DEPTH_GUI_TEXT = 0.2;
    this.DEPTH_GUI_IMAGE = 0.1;
  ...
  initTutorial() {
    ...
    this.textTutorial = this.add.bitmapText(
      this.midX - 100,
      this.midY - 30,
      MainGame.fontName,
      ""
  ...
  initMainButtons() {
    ...
    var skill_cd1 = this.add.image(
      buttonSkill1.x,
      buttonSkill1.y - 36,
      "ss_main",
      "skill_cd_0000"
    );
    skill_cd1.setOrigin(0.5, 0);
    this.layerGUI.add(skill_cd1);
    var skill_cd2 = this.add.image(
      buttonSkill2.x,
      buttonSkill2.y - 36,
      "ss_main",
      "skill_cd_0000"
    );
    skill_cd2.setOrigin(0.5, 0);
    this.layerGUI.add(skill_cd2);
    var skill_cd3 = this.add.image(
      buttonSkill3.x,
      buttonSkill3.y - 36,
      "ss_main",
      "skill_cd_0000"
    );
    skill_cd3.setOrigin(0.5, 0);
    this.layerGUI.add(skill_cd3);
    this.skill_cd1 = skill_cd1;
    this.skill_cd2 = skill_cd2;
    this.skill_cd3 = skill_cd3;
    var ramka_skill = this.add.sprite(
      buttonSkill1.x,
      buttonSkill1.y,
      "ss_main"
    );
    ...
    var buttonForge = new ButtonText(
      920,
      posY,
      "ss_main",
      "btn_forge_0000",
      this.clickForgeButton,
      this,
      ""
    );
    ...
    this.forge_crop = new Phaser.Geom.Rectangle(
      0,
      0,
      this.icon_forge2.height,
      0
    );
    ...
    var icon_fast_car = this.add.image(
      -48,
      32,
      this.SPRITE_SHEET,
      "icon_r1_0000"
    );
    icon_fast_car.setScale(0.65);
    icon_fast_car.setOrigin(0.8, 1);
    ...
    var effectBlink1 = this.add.sprite(
      buttonSkill1.x,
      buttonSkill1.y,
      "ss_main"
    );
    ...
    var effectBlink2 = this.add.sprite(
      buttonSkill2.x,
      buttonSkill2.y,
      "ss_main"
    );
    ...
    var effectBlink3 = this.add.sprite(
      buttonSkill3.x,
      buttonSkill3.y,
      "ss_main"
    );
    ...
    var buttonUpgradeWall = new ButtonText(
      this.midX + 265,
      posY - 6,
      "ss_main",
      "btn_wall_0000",
      this.clickUpgradeWallButton,
      this,
      "123.456"
    );
    ...
    this.hp_wall_crop = new Phaser.Geom.Rectangle(
      0,
      0,
      0,
      this.hp_wall2.height
    );
    ...
    this.text_wallhp = MainGame.addText(
      this,
      buttonUpgradeWall,
      0,
      hp_wall1.y - 1,
    ...
    var iconAdvFortune = this.add.image(
      this.buttonFortuna.x + 21,
      this.buttonFortuna.y - 21,
      "ss_main",
      "icon_adv_0000"
    );
  ...
  showFinishWindow(vIsWin) {
    ...
    if (vIsWin) {
      var offY = 35;
      var popup_victory = this.add.image(
        0,
        -163,
        this.SPRITE_SHEET,
        "popup_victory_0000"
      );
      var flash_select_gun = this.add.image(
        0,
        83,
        this.SPRITE_SHEET,
        "flash_select_gun_0000"
      );
      var icon_coin = this.add.image(
        5,
        -80 + offY,
        this.SPRITE_SHEET,
        "money_0000"
      );
      icon_coin.setScale(0.7);
      var icon_chick = this.add.image(
        5,
        -35 + offY,
        this.SPRITE_SHEET,
        "icon_chick_0000"
      );
      var buttonWinX2 = new ButtonText(
        0,
        80,
        this.SPRITE_SHEET,
        "btn_buy2_0000",
        this.clickWinX2Button,
        this,
        "+ 252K"
      );
      MainGame.updateTextWidth(buttonWinX2.text, 200);
      buttonWinX2.text.x = -5;
      var icon_btn_coin = this.add.image(
        -85,
        -1,
        this.SPRITE_SHEET,
        "money_0000"
      );
      var icon_btn_reward = this.add.image(
        85,
        -1,
        this.SPRITE_SHEET,
        "icon_reward_0000"
      ...
      var text_earned = MainGame.addText(
        this,
        this.layerFinishWindow,
        -125,
        -80 + offY,
        MainGame.GAME_TEXT.earned,
        26,
        true
      );
      var text_killed = MainGame.addText(
        this,
        this.layerFinishWindow,
        -125,
        -35 + offY,
        MainGame.GAME_TEXT.killed,
        26,
        true
      );
      ...
      text_earned.setOrigin(0, 0.5);
      text_killed.setOrigin(0, 0.5);
      var text_title_win = MainGame.addText(
        this,
        this.layerFinishWindow,
        0,
        -133,
        MainGame.GAME_TEXT.wave_cleared,
        34,
        true
      );
      var text_finish_coins = MainGame.addText(
        this,
        this.layerFinishWindow,
        icon_coin.x + 30,
        -80 + offY,
      ...
      var text_finish_enemies = MainGame.addText(
        this,
        this.layerFinishWindow,
        icon_coin.x + 30,
        -35 + offY,
      ...
      text_finish_coins.setOrigin(0, 0.5);
      text_finish_enemies.setOrigin(0, 0.5);
      var text1_warm = MainGame.convertNumberFormat(
        this.gameScreen.coins_earned
      );
      var text2_warm = MainGame.convertNumberFormat(
        this.gameScreen.enemies_killed
      );
      var text3_warm = MainGame.convertNumberFormat(
        this.gameScreen.coins_earned
      );
      ...
      var popup_defeat = this.add.image(
        0,
        -160,
        this.SPRITE_SHEET,
        "popup_defeat_0000"
      ...
      var buttonContinue = new ButtonText(
        ...
        this.SPRITE_SHEET,
        "btn_replay_0000",
        this.clickContinueDefeat,
        this
      );
      this.layerFinishWindow.add(buttonContinue);
      var text_title_lose = MainGame.addText(
        this,
        this.layerFinishWindow,
        0,
        -131,
        MainGame.GAME_TEXT.defeat,
        34,
        true
      );
      var text_no_give_up = MainGame.addText(
        this,
        this.layerFinishWindow,
        0,
        85 + 5,
      ...
      var text_try_merge_gun = MainGame.addText(
        this,
        this.layerFinishWindow,
        0,
        115 + 5,
  ...
  initLevelBar() {
    ...
    this.levelBarB = this.add.image(
      pos.x + 107,
      pos.y - 11,
      "ss_main",
      "exp1_0000"
    );
    this.levelBarT = this.add.image(
      pos.x + 107,
      pos.y - 11,
      "ss_main",
      "exp2_0000"
    ...
    this.textLevel = this.add.bitmapText(
      pos.x - 1,
      pos.y + 6,
      MainGame.fontName,
      this.gameScreen.currentLevel,
      26
    );
    this.textLevel.setOrigin(0.5, 0.5);
    ...
    var text_level = MainGame.addText(
      this,
  ...
  initWavePanel() {
    ...
    var panel_bar = this.add.image(pos.x, pos.y, "ss_main", "panel_bar_0000");
    this.waveBarB = this.add.image(
      pos.x + 107,
      pos.y - 11,
      "ss_main",
      "wave_bar1_0000"
    );
    this.waveBarT = this.add.image(
      pos.x + 107,
      pos.y - 11,
      "ss_main",
      "wave_bar2_0000"
    );
    this.waveBarT_crop = new Phaser.Geom.Rectangle(
      0,
      0,
      0,
      this.waveBarT.height
    );
    this.waveBarT.setCrop(this.waveBarT_crop);
    this.textWave = this.add.bitmapText(
      pos.x - 1,
      pos.y + 6,
      MainGame.fontName,
      "1",
    ...
    this.textWave.setOrigin(0.5, 0.5);
    ...
    var text_wave = MainGame.addText(
      this,
      this.layerPanelWave,
      pos.x,
      pos.y - 13,
      MainGame.GAME_TEXT.wave,
      13,
      true
    );
    text_wave.setOrigin(0.5, 0.5);
  ...
  initOfferTV() {
    var buttonPanelTV = new ButtonText(
      58,
      220,
      "ss_main",
      "btn_free_boost_0000",
    ...
    var icon_forge1 = this.add.image(
      -10,
      -8,
      "ss_main",
      "indicator_boost_0000"
    );
  ...
  updateFastBuy() {
    ...
    this.icon_fast_car.setScale(0.65);
  ...
  updateWallBuy() {
    ...
    this.icon_wall_coin.x =
      this.buttonUpgradeWall.text.x -
      this.buttonUpgradeWall.text.width * 0.5 -
      15;
  ...
  initBasketTrash() {
    var posX = 950;
    var posY = 590;
    this.icon_trash = this.gameScreen.add.image(
      posX,
      posY,
      "ss_main",
      "btn_delete_0000"
    );
    var effect = this.gameScreen.add.sprite(
      this.icon_trash.x,
      this.icon_trash.y,
      "ss_main"
    );
  ...
  enableMainButtons() {
    ...
    if (
      this.gameScreen.isGoTutorial &&
      this.gameScreen.tutorialStep >= 3 &&
      this.gameScreen.tutorialStep <= 5
    )
      return;
    this.buttonAddCar.enableInput();
    this.buttonUpgradeWall.enableInput();
  ...
  initCoinsPanel() {
    ...
    this.textCoins = this.add.bitmapText(
      posX + 5,
      posY - 1,
      MainGame.fontName,
      "192.640K",
  ...
  initMergeAnimation() {
    ...
    var icon_window1 = this.add.image(
      0,
      -30,
      this.SPRITE_SHEET,
      "icon_window1_0000"
    ...
    var unlocked_car = this.add.image(
      35,
      17,
      this.SPRITE_SHEET,
      "icon_r1_0000"
    );
    unlocked_car.setOrigin(0.85, 1);
    ...
    var icon_window1_1 = this.add.image(
      0,
      0,
      this.SPRITE_SHEET,
      "icon_window1_0000"
    );
    var icon_window1_2 = this.add.image(
      0,
      0,
      this.SPRITE_SHEET,
      "icon_window1_0000"
    );
    var icon_car1_merge = this.add.image(
      35,
      icon_window1_1.y + 38,
      this.SPRITE_SHEET,
      "icon_r1_0000"
    );
    icon_car1_merge.setOrigin(0.85, 1);
    var icon_car2_merge = this.add.image(
      35,
      icon_window1_2.y + 38,
      this.SPRITE_SHEET,
      "icon_r1_0000"
    );
    icon_car2_merge.setOrigin(0.85, 1);
    icon_window1_1.setScale(0.8);
    icon_window1_2.setScale(0.8);
    icon_car1_merge.setScale(0.8);
    icon_car2_merge.setScale(0.8);
    ...
    var star_flash1 = this.add.image(
      0,
      0,
      this.SPRITE_SHEET,
      "star_flash_0000"
    ...
    var star_flash2 = this.add.image(
      0,
      0,
      this.SPRITE_SHEET,
      "star_flash_0000"
    ...
    var star_flash3 = this.add.image(
      0,
      0,
      this.SPRITE_SHEET,
      "star_flash_0000"
    ...
    var icon_window2 = this.add.image(
      140,
      70,
      this.SPRITE_SHEET,
      "icon_window2_0000"
    ...
    var text_unlocked = MainGame.addText(
      this,
      this.layerUnlocked,
      0,
      -237,
    ...
    var text_damage = MainGame.addText(
      this,
      this.layerUnlocked,
      0,
      50,
    ...
    this.mergeCars_textNext = MainGame.addText(
      this,
      this.layerUnlocked,
      icon_window2.x,
      icon_window2.y - 52,
    ...
    this.mergeCars_textQuestion = MainGame.addText(
      this,
      this.layerUnlocked,
      icon_window2.x,
      icon_window2.y - 2,
  ...
  showMergeAnimation(vType) {
    ...
    this.textDamage.setText(
      text_dmg_value.toUpperCase() + ": " + value_dmg_warm
    );
  ...
  initSettingsWindow() {
    ...
    var buttonReset = new ButtonText(
      0,
      215,
      this.SPRITE_SHEET,
      "btn_buy_0000",
      this.openResetProgress,
      this,
      MainGame.GAME_TEXT.reset_progress
    );
    buttonReset.text.setFontSize(20);
    buttonReset.text.x = 25;
    this.layerSettingsWindow.add(buttonReset);
    this.buttonReset = buttonReset;
    var icon_reset = this.add.image(
      -95,
      -3,
      this.SPRITE_SHEET,
      "btn_reset_0000"
    ...
    var text_title = MainGame.addText(
      this,
    ...
    var textMusic = MainGame.addText(
      this,
      this.layerSettingsWindow,
      0,
      logo_tbs.y + 70,
    ...
    var text_musian = MainGame.addText(
      this,
      this.layerSettingsWindow,
      0,
      textMusic.y + 30,
  ...
  initResetProgressWindow() {
    ...
    this.layerResetProgressWindowMain.setDepth(
      this.gameScreen.DEPTH_layerMerge
    );
    ...
    var buttonOk = new ButtonText(
      -105,
      90,
      this.SPRITE_SHEET,
      "btn_buy2_0000",
      this.clickResetConfirm,
      this,
      MainGame.GAME_TEXT.ok
    );
    buttonOk.setOriginalScale(0.7);
    this.layerResetProgressWindow.add(buttonOk);
    var buttonCancel = new ButtonText(
      105,
      90,
      this.SPRITE_SHEET,
      "btn_buy_0000",
      this.closeResetProgress,
      this,
      MainGame.GAME_TEXT.cancel
    );
    buttonCancel.setOriginalScale(0.7);
    this.layerResetProgressWindow.add(buttonCancel);
    var textQuestion = MainGame.addText(
      this,
      this.layerResetProgressWindow,
      0,
      -50,
      MainGame.GAME_TEXT.text_reset,
      24,
      true
    );
  ...
  initOfflineEarningWindow() {
    ...
    this.layerOfflineEarningWindowMain.setDepth(
      this.gameScreen.DEPTH_layerMerge
    );
    ...
    var posX = 0;
    var posY = -50;
    var offline_container = this.add.image(
      posX + 10,
      posY,
      this.SPRITE_SHEET,
      "offline_container_0000"
    );
    ...
    var offline_coins = this.add.image(
      posX - 11,
      posY + 36,
      this.SPRITE_SHEET,
      "offline_coins_0000"
    ...
    var buttonContinue = new ButtonText(
      ...
      this.SPRITE_SHEET,
      "btn_buy2_0000",
      this.clickOfflineEarningButton,
      this,
    ...
    var icon_reward = this.add.image(
      85,
      -1,
      this.SPRITE_SHEET,
      "icon_reward_0000"
    ...
    text_title.setTint(16777215);
    MainGame.updateTextWidth(text_title, 400);
    var offline_earning_text = MainGame.addText(
      this,
      this.layerOfflineEarningWindow,
      0,
      75,
  ...
  initLevelUpWindow() {
    ...
    var icon_newmoney = this.add.image(
      pos.x - 55,
      pos.y + 30,
      "ss_main",
      "money_0000"
    );
    icon_newmoney.setScale(0.7);
    var levelup_text_money = MainGame.addText(
      this,
    ...
    levelup_text_money.setOrigin(0, 0.5);
  ...
  showLevelUpRewards2() {
    ...
    text_coins_warm = MainGame.convertNumberFormat(
      this.gameScreen.amount_coins
    );
  ...
  initUpgradeWindow() {
    ...
    var arrow_icon = this.add.sprite(
      posX + 0,
      posY + 0,
      this.SPRITE_SHEET,
      "arrow_0000"
    ...
    var panel_number1 = this.add.image(
      posX - 110 - 50,
      posY - 100,
      this.SPRITE_SHEET,
      "panel_number_0000"
    ...
    var panel_number2 = this.add.image(
      posX + 110 - 30,
      posY - 100,
      this.SPRITE_SHEET,
      "panel_number_0000"
    ...
    var gun1 = this.add.image(
      -130 + 10 + 35,
      posY + 47,
      this.SPRITE_SHEET,
      "icon_r1_0000"
    );
    gun1.setOrigin(0.85, 1);
    this.layerUpgradeWindow.add(gun1);
    var gun2 = this.add.image(
      130 + 35,
      posY + 47,
      this.SPRITE_SHEET,
      "icon_r1_0000"
    );
    gun2.setOrigin(0.85, 1);
    ...
    MainGame.updateTextWidth(text_title, 400);
    text_title.setTint(16777215);
    var text_level1 = MainGame.addText(
      this,
      this.layerUpgradeWindow,
      panel_number1.x + 64,
      panel_number1.y - 2,
    ...
    var text_level2 = MainGame.addText(
      this,
      this.layerUpgradeWindow,
      panel_number2.x + 64,
      panel_number1.y - 2,
    ...
    var text_levelGun1 = MainGame.addText(
      this,
      this.layerUpgradeWindow,
      panel_number1.x - 1,
      panel_number1.y - 2,
    ...
    var text_levelGun2 = MainGame.addText(
      this,
      this.layerUpgradeWindow,
      panel_number2.x - 1,
      panel_number2.y - 2,
  ...
  showUpgradeWindow(vLevelGun) {
    ...
    if (MainGame.isAPI) {
      if (MainGame.API_POKI && MainGame.API_POKI.api_isAdblock)
        this.buttonFreeUpgrade.setEnable(false);
    } else {
  ...
  initBoosterWindow() {
    ...
    var popup_drop = this.add.sprite(
      0,
      0,
      this.SPRITE_SHEET,
      "popup_drop_0000"
    ...
    var helicopter_icon = this.add.image(
      0,
      -82,
      this.SPRITE_SHEET,
    ...
    var reward_icon = this.add.image(
      0,
      12,
      this.SPRITE_SHEET,
      "reward_boost_0000"
    ...
    MainGame.updateTextWidth(text_title, 400);
    text_title.setTint(16777215);
    var reward_text = MainGame.addText(
      this,
      this.layerBoosterWindow,
      0,
      85,
      MainGame.GAME_TEXT.bonus_merge,
      24,
      true
    );
  ...
  initRewardWindow() {
    ...
    var iconRewardWindow = this.add.image(
      posX,
      posY,
      this.SPRITE_SHEET,
      "reward_box6_0000"
  ...
  closeRewardWindow() {
    ...
    if (MainGame.reward_wheel)
      this.gameScreen.getRewards(MainGame.reward_wheel);
  ...
  initFortunaWheelWindow() {
    ...
    var posX = 0;
    var posY = -15;
    var wheel_fortune = this.add.image(
      posX,
      posY,
      this.SPRITE_SHEET,
      "wheel_fortune_0000"
    ...
    var ramka_fortune = this.add.image(
      posX,
      posY,
      this.SPRITE_SHEET,
      "ramka_fortune_0000"
    ...
    var arrow_fortune = this.add.image(
      posX,
      posY - 162,
      this.SPRITE_SHEET,
      "arrow_fortune_0000"
    ...
    text_title.setTint(16777215);
    MainGame.updateTextWidth(text_title, 400);
    var text_free_time = MainGame.addText(
      this,
      this.layerFortunaWheelWindow,
      -120 - 40,
      240,
    ...
    var text_nextfreein = MainGame.addText(
      this,
      this.layerFortunaWheelWindow,
      100 + 40,
      240,
  ...
  initShop() {
    ...
    this.textCoinsShop = MainGame.addText(
      this,
      this.layerShop,
      20 + offsetX,
      -232,
  ...
  addSlider(offsetX) {
    ...
    this.input.on(
      ...
      function (pointer, gameObjects, deltaX, deltaY, deltaZ) {
        ...
        _this.current_pos.y = _this.limit(_this.current_pos.y + deltaY * 0.5);
  ...
  addContentTab1(offsetX) {
    ...
    for (var i = 1; i <= this.MAX_TYPES_CAR; i++) {
      car = this.addShopItemMain(
        -8 + offsetX,
        this.itemShop_WIDTH * i - 130 - this.itemShop_WIDTH,
        i
      );
      this.arShopCars.push(car);
    }
    for (var i = 1; i <= this.MAX_TYPES_CAR; i++) {
      car = this.addShopItemText(
        -8 + offsetX,
        this.itemShop_WIDTH * i - 130 - this.itemShop_WIDTH,
        i
      );
  ...
  addShopItemText(vX, vY, vNum) {
    ...
    text_num.setTint(0);
    var text_dmg = MainGame.addText(
      this,
      item,
      vX + 40,
      vY - 37,
      MainGame.GAME_TEXT.damage,
      18,
      true,
      true
    );
    text_dmg.setOrigin(0, 0.5);
    car.textField_dmg = text_dmg;
  }
  addContentTab2(offsetX) {
    this.itemPrivilege1 = this.addShopItemsTabPrivilegies1(
      -8 + offsetX,
      this.itemShop_WIDTH * 0 - 130
    );
    this.itemPrivilege2 = this.addShopItemsTabPrivilegies2(
      -8 + offsetX,
      this.itemShop_WIDTH * 1 - 130
    );
    this.itemPrivilege3 = this.addShopItemsTabPrivilegies3(
      -8 + offsetX,
      this.itemShop_WIDTH * 2 - 130
    );
  }
  addShopItemsTabPrivilegies1(vX, vY) {
    ...
    var text_title = MainGame.addText(
      ...
      vX - 112,
      vY + 40,
      MainGame.GAME_TEXT.upgrade_1,
      18,
      true,
      true
    );
    var text_lvl = MainGame.addText(
      this,
      item,
      vX - 206,
      vY + 2,
      MainGame.GAME_TEXT.lvl,
      18,
      true,
      true
    );
    ...
    var text_value = MainGame.addText(
      this,
      item,
      vX + 10,
      vY - 38,
  ...
  updateShopItem() {
    ...
    for (var i = 0; i < this.MAX_TYPES_CAR; i++) {
      ...
      if (i + 2 > this.gameScreen.nextCarLevel) {
        ...
        var value_dmg_warm = MainGame.convertNumberFormat(value_dmg);
        item.textField_dmg.setText(
          MainGame.GAME_TEXT.damage + " : " + value_dmg_warm
        );
        if (i > 0 && this.gameScreen.nextCarLevel < i + 6) {
          ...
          var price = Math.round(
            this.gameScreen.arCurrentPricesCar[i] *
              this.gameScreen.factorDiscount
          );
...
Pool.prototype.getFree = function () {
  const freeObject = this.nextFree
    ? this.nextFree
    : this.addNewObject(this.newPoolObject());
...
Tower = function (game, vLayer, vX, vY, vType) {
  ...
  this.targetAim = null;
  this.timeReload = 50;
  this.timeShoot = Math.floor(this.timeReload * 0.5);
...
Tower.prototype.setSkinTower = function (vType) {
  ...
  this.view.skeleton.setAttachment(
    "shoulder_L",
    "shoulder_r" + this.skin_shoulder
  );
  this.view.skeleton.setAttachment(
    "shoulder_R",
    "shoulder_r" + this.skin_shoulder
  ...
  this.view.state.tracks[0].trackTime = MyMath.getRandomInt(1, 10) * 0.5;
...
Enemy.prototype.updateSpeed = function () {
  ...
  if (!this.isReachedWall) {
    ...
    if (this.type == 51 || this.type == 52 || this.type == 53)
      this.speed = this.game.SPEED_ENEMY * 2;
  }
};
...
Enemy.prototype.setNewBot = function (
  vId,
  x,
  y,
  vData,
...
Enemy.prototype.getDamage = function (damage) {
  ...
  if (this.health <= 0) {
    ...
    if (this.typeUnit == "car") {
      if (this.health <= this.health_max * 0.5) {
        this.goalX = this.x;
      }
    }
  }
...
Enemy.prototype.startAttack = function () {
  ...
  if (this.type == 1 || this.type == 101) {
    ...
    this.timeAttack = this.reloading * 0.7;
...
Enemy.prototype.updateCar = function () {
  if (this.timerCar > 0) {
    ...
    if (this.timerCar >= 30 && this.stepAttack1) {
      this.game.addMobFromCar(
        this.x + this.desantPos.x,
        this.y + this.desantPos.y + 0,
        4,
        {
